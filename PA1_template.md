...
```r
setwd("C:/Users/csahoo/Desktop/DataScience")
...
```r
ggplot(SummedDataByDay, aes(x = totalsteps)) + geom_histogram(fill = "steelblue", binwidth=1000) +labs(title = "Total Daily Steps", x = "Steps", y ="Frequency")
```
...
![](PA1_template_files/figure-html/SummedDataByDay-1.png)<!-- -->
...
ggplot(MeanDataByInterval, aes(x = interval, y=steps)) +  labs(title = "Sum of Steps by Interval", x = "interval", y = "steps")+  geom_line(color="red") 
```
